    ...
    <div className="space-y-4">
      <div className="grid gap-3 lg:grid-cols-[1.3fr_0.9fr_0.9fr_0.9fr_auto]">
        <div className="relative">
          ...
          <Input className="pl-9" placeholder="Buscar por nome, número do estudante ou curso..." value={studentSearchTerm} onChange={(event) => onStudentSearchTermChange(event.target.value)} />
        </div>
