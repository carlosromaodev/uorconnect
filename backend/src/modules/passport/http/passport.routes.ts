...
const adminSurpriseQrSchema = z.object({
  ...
  effectValue: z.number(),
  dynamicRules: z.object({
    convertAfterLosses: z.number().nullable().optional(),
    convertToEffectType: z.string().nullable().optional(),
    convertToEffectValue: z.number().nullable().optional(),
    hintAfterLoss: z.string().nullable().optional(),
  }).nullable(),
...
<body>
  <header>
    ...
    <div>
      <h1>Lote de QR surpresa</h1>
      <p>${surprises.length} códigos numerados para impressão</p>
    </div>
  </header>
