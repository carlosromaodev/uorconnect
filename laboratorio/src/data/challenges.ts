...
export const challengeContestConfig: ChallengeContestConfig = {
  contestName: "Laboratório UOR Connect",
  subtitle: "Plataforma técnica do Laboratório para arena de pseudocódigo, organização de sessões e operação académica.",
  course: "1º Ano de Informática",
  scheduledStartAt: "2026-04-15T18:00:00.000Z",
  durationMinutes: 120,
  venue: "Laboratório UOR Connect",
  generalRules: [
  ...
  waitingMessages: [
    ...
    "> a aguardar libertação oficial da janela da arena",
